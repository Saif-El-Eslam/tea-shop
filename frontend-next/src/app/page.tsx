...
const HomePage: React.FC = () => {
  ...
  return (
    <div>
      {!state.loading && state.user && state.user?.role === "user" && (
        <div className="p-4">
          ...
          <section>
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="min-h-36 order-2 md:order-1 p-8 text-center flex items-center justify-center bg-[#D0E6A5] text-white">
                Crafting tranquility, one brew at a time. Experience the
                serenity of tea at TeaLife, where every sip brings a moment of
                calm and delight.
              </div>
